...
4. persist and restore the CEP panel's run/history selection after a panel/service restart;
   best-attempt playback and non-authoritative five-dimension human grading are implemented.
