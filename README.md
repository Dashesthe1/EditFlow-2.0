...
M4 now advances through point tracking, two-point rotation/scale tracking, four-point and perspective tracking, mask tracking, face tracking, stabilization, semantic attach points, subject/object segmentation, segmentation-to-mask/matte export, and manual repair/resume. Point tracking, guarded native analysis, two-point transform derivation, and four-point perspective/homography derivation now have retained real-AE evidence; the next tranche continues into isolation-oriented tracking capabilities. Development continues on the persistent warm After Effects process so routine proof cycles stay around 30 seconds or faster wherever the operation itself allows it.
