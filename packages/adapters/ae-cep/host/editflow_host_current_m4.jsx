...
(function () {
  ...
  var trackingSupport = new File(hostDir.fsName + "/editflow_host_m4_tracking_render_support.jsx");
  ...
  if (!trackingSupport.exists) throw new Error("EditFlow M4 tracking render support is missing: " + trackingSupport.fsName);
  if (!trackingRender.exists) throw new Error("EditFlow M4 tracking render wrapper is missing: " + trackingRender.fsName);
  $.evalFile(trackingSupport);
