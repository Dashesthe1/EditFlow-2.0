(function () {
  ...
  function ensureHostDispatcher() {
    return new Promise(function (resolve, reject) {
      ...
      var hostPath;
      try {
        hostPath = extensionRootPath() + "/host/editflow_host_current_v18.jsx";
      } catch (error) {
      ...
      var script = "(function(){try{" +
        "if(typeof $.global.EditFlow2_dispatch===\"function\"&&$.global.EditFlow2_HOST_PROTOCOL_18===true)return \"" + HOST_BOOTSTRAP_OK + "\";" +
        ...
        "$.evalFile(hostFile);" +
        "if(typeof $.global.EditFlow2_dispatch!==\"function\"||$.global.EditFlow2_HOST_PROTOCOL_18!==true)return \"" + HOST_BOOTSTRAP_ERROR_PREFIX + "protocol 1.8 dispatcher did not register\";" +
