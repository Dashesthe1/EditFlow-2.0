(function () {
  ...
  var KNOWN_PROTOCOLS = ["1.7.0", "1.6.0", "1.5.0", "1.4.0", "1.3.0", "1.2.0", "1.1.0"];
  ...
  function ensureHostDispatcher() {
    return new Promise(function (resolve, reject) {
      ...
      var hostPath;
      try {
        hostPath = extensionRootPath() + "/host/editflow_host_current_v17.jsx";
      } catch (error) {
      ...
      var script = "(function(){try{" +
        "if(typeof $.global.EditFlow2_dispatch===\"function\"&&$.global.EditFlow2_HOST_PROTOCOL_17===true)return \"" + HOST_BOOTSTRAP_OK + "\";" +
        ...
        "$.evalFile(hostFile);" +
        "if(typeof $.global.EditFlow2_dispatch!==\"function\"||$.global.EditFlow2_HOST_PROTOCOL_17!==true)return \"" + HOST_BOOTSTRAP_ERROR_PREFIX + "protocol 1.7 dispatcher did not register\";" +
