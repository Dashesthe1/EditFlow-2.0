...
export const M4_TRACKING_REPAIR_RESUME_CAPABILITY_V1: CapabilityRecord = {
  ...
  limitations: [
    ...
    "Retained live proof covers guarded native Analyze Forward and Analyze Backward resume after exact Feature Center correction plus exact static-path mask vertex repair through protocol 1.2. Separate retained automatic-corrective proofs cover persistent low confidence, persistent drift, and explicit identity-confidence loss through exact correction, guarded Analyze Forward, verification, and resume; persistent drift also has retained automatic Analyze Backward evidence. Low-confidence/identity-loss automatic Backward combinations, tangent/animated mask repair, and occlusion recovery remain unclaimed. Deterministic automatic escalation is declared separately.",
  ],
