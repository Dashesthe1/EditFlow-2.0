...
const M3_LAYER_CONTROLS_DECLARED_CAPABILITIES_V16: readonly CapabilityRecord[] =
  AE_LAYER_CONTROLS_COMMANDS_V16.map((command): CapabilityRecord => ({
    ...
    domain: "layer",
    description: `M3 typed AE layer-controls command '${command}'. Protocol 1.6 covers deterministic layer switches and stacking order; motion blur and frame blending remain in the later compound rendering-controls tranche.`,
    status: "PARTIAL",
    ...
    visualProofProfile: command === "layer.controls.readback" ? null : "LAYER_CONTROLS_STRUCTURAL_CHECKPOINT",
