...
export const M4_MASK_POINT_REPAIR_CAPABILITY_V1: CapabilityRecord = {
  ...
  visualProofProfile: "M4_MASK_POINT_REPAIR_STATIC_VERTEX_VISUAL",
  ...
  limitations: [
    ...
    "Retained warm real-AE proof covers exact static-path vertex repair, protocol 1.2 post-write readback, typed Undo restoration, reapply, viewer-visible correction, and baseline cleanup.",
    "Tangent-only repair and animated exact-key repair remain structurally tested but do not yet have retained real-AE acceptance evidence.",
