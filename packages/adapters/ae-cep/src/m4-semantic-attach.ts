...
export const M4_SEMANTIC_ATTACH_CAPABILITY_V1: CapabilityRecord = {
  ...
  visualProofProfile: "M4_EXIT_GATE_SEMANTIC_ATTACH_REAL_AE",
  ...
  limitations: [
    ...
    "Accepted transfer proof is bounded to exact evidence-backed upstream geometry; the resolver still refuses guessed identity, class, or landmark data.",
  ],
