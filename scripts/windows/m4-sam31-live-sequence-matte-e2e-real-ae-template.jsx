(function () {
  ...
  function responseOk(response) {
    ...
    var request = {
      ...
      transactionId: "M4_SAM31_LIVE_SEQUENCE_MATTE_E2E_REAL_AE",
      operationId: "M4_SAM31_LIVE_SEQUENCE_MATTE_E2E_REAL_AE_" + requestCounter,
      capabilityId: capabilityId,
      command: command,
      payload: payload,
      expectedHostProjectRevision: expectedRevision,
      readbackProfile: "M4_SAM31_LIVE_SEQUENCE_MATTE_E2E_REAL_AE"
    };
  ...
  try {
    ...
    var reserved = [
      "M4_SAM31_E2E_BG_MEDIA", "M4_SAM31_E2E_SUBJECT_MEDIA", "M4_SAM31_E2E_COMP",
    ...
    dispatch("1.1.0", "ae.media.import", "media.import", {
      path: plan.fixtures.backgroundPath, stableId: "M4_SAM31_E2E_BG_MEDIA", sequence: false
    });
    dispatch("1.1.0", "ae.media.import", "media.import", {
      path: plan.fixtures.subjectPath, stableId: "M4_SAM31_E2E_SUBJECT_MEDIA", sequence: false
    });
    dispatch("1.1.0", "ae.comp.create", "comp.create", {      stableId: "M4_SAM31_E2E_COMP", name: "M4 Dynamic Segmentation Matte Proof",
    ...
    dispatch("1.1.0", "ae.layer.create", "layer.add_media", {
      stableId: "M4_SAM31_E2E_BG_LAYER", comp: { stableId: "M4_SAM31_E2E_COMP" },
      item: { stableId: "M4_SAM31_E2E_BG_MEDIA" }
    });
    dispatch("1.1.0", "ae.layer.create", "layer.add_media", {
      stableId: plan.targetState.stableId, comp: { stableId: "M4_SAM31_E2E_COMP" },
      item: { stableId: "M4_SAM31_E2E_SUBJECT_MEDIA" }
    });
    dispatch("1.1.0", "ae.layer.transform.set", "layer.set_transform", {
      comp: { stableId: "M4_SAM31_E2E_COMP" }, layer: { stableId: plan.targetState.stableId },
    ...
    proofComp = findItem("M4_SAM31_E2E_COMP");
    ...
    var matteReadback = dispatch("1.1.0", "ae.object.readback", "readback.object", {
      kind: "LAYER", comp: { stableId: "M4_SAM31_E2E_COMP" },
    ...
    try {
      var ownedComp = findItem("M4_SAM31_E2E_COMP");
      if (ownedComp) ownedComp.remove();
    } catch (_) {}
    var ownedItems = [
      plan && plan.plan ? plan.plan.importItemStableId : "M4_SAM31_E2E_MASK_MEDIA",
      "M4_SAM31_E2E_SUBJECT_MEDIA", "M4_SAM31_E2E_BG_MEDIA"
    ];
