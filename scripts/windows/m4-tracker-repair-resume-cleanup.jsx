(function () {
  ...
  var out = new File(root.fsName + "/proofs/artifacts/m4-tracker-repair-resume-cleanup.json");
  ...
  try{
    ...
    var setup=readJson(setupFile),folder=find("EF2_M4_REPAIR_RESUME_OWNED"),fixture=find("RR_FIXTURE"),source=find("RR_SOURCE"),black=find("RR_BLACK"),feature=find("RR_FEATURE");
    if(!setup.ok)throw new Error("Setup evidence not accepted.");
    if(folder){
    ...
    r={ok:app.project.numItems===setup.baselineItems,itemCountAfter:app.project.numItems,baselineItems:setup.baselineItems,autoSolidsRemoved:autoSolidsRemoved,folderRemoved:find("EF2_M4_REPAIR_RESUME_OWNED")===null,fixtureRemoved:find("RR_FIXTURE")===null,sourceRemoved:find("RR_SOURCE")===null};
