(function () {
  ...
  var out=new File(Folder.temp.fsName+"/M6_native_echo_control01.mp4");if(out.exists)out.remove();om.file=out;
  app.project.renderQueue.render();
  if(!out.exists||out.length<=0)throw new Error("M6_ECHO_CONTROL_RENDER_EMPTY");
  rq.remove();
}());