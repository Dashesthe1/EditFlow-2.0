(function () {
  ...
  for(var j=1;j<=c.numLayers;j++){var l=c.layer(j),t=l.property("ADBE Transform Group");
    ...
    for(var e=1;e<=fx.numProperties;e++){
      ...
      for(var q=1;q<=effect.numProperties;q++){var ep=effect.property(q);if(ep&&ep.propertyType===PropertyType.PROPERTY)f.writeln("EFFECT_PROP\t"+e+"\t"+q+"\t"+ep.matchName+"\t"+ep.value);}
    }
  }
  f.close();
}());
